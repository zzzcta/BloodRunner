...
var characters_data : Dictionary ={
	"Bigmin" : ["res://Recursos/Fuentes/MonomaniacOne-Regular.ttf",20,0.03,Color.DARK_GRAY,"res://Recursos/Sprites/UI/Border All 10.png"],
	"AUX6B" : ["res://Recursos/Fuentes/MonomaniacOne-Regular.ttf",16,0.03,Color.CORNFLOWER_BLUE,"res://Recursos/Sprites/UI/Border All 10.png"]
}
